...
def colorByTc(X_reduced, y):
    ...
    gfg.set(title="$T_\mathrm{C}$ Data UMAP Projection - DS1")

    plt.savefig('./Plots/UMAP-Temp-DS1.png', bbox_inches='tight')
...
def colorByComposition(X_reduced, y):
    ...
    ax.set_title("$T_\mathrm{C}$ Data UMAP Projection - DS1", fontsize = 18)
    ...
    plt.savefig('./Plots/UMAP-ELEM-DS1.png', bbox_inches='tight')
